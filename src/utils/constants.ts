export const LOTUS_RPC_ENDPOINT = {
  CALIBRATION: `http://192.168.1.135:1234/rpc/v0`,
  // CALIBRATION: `http://192.168.1.233:1301/rpc/v0`,
  MAINNET: `http://192.168.1.233:1234/rpc/v0`,
};

export const LOTUS_AUTH_TOKEN =
  'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJBbGxvdyI6WyJyZWFkIiwid3JpdGUiLCJzaWduIiwiYWRtaW4iXX0.uNA0QfyojOwEDTjT3yV4gEsRQg62dQj6ztGoLolHTsE';
